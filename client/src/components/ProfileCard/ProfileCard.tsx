  ...
  return (
    <section>
      <div className="profile-container">
        ...
        <div className=" w-[892px] rounded-lg shadow-[0px_1px_4px_2px_#00000025]">
          <div className="relative flex w-full text-center h-36 mt-30">
            <div>
            ...
            <Link href="./">
              <div className="mt-10 ml-10 leading-loose text-left">
                ...
                <p className="mt-2 text-base font-light profile-subtitle">
                  Información de tu identificación oficial y tu actividad
                  fiscal.
                </p>
              </div>
            </Link>
          ...
          <div className="relative flex w-full text-center  h-36">
            <div>
              <Link
          ...
          <div className="relative flex w-full text-center h-36">
            ...
            <Link href="./">
              <div className="mt-10 ml-10 leading-loose text-left">
                ...
                <p className="mt-2 text-base font-light profile-subtitle">
                  Tarjetas que has registrado en tu cuenta.
                </p>
              </div>
            </Link>
            <div className="mt-10 ml-10 leading-loose text-left">
          ...
          <div className="relative flex w-full mb-32 text-center h-36">
            <div>
              <Link href="./" className="relative flex profile-icons">
                <Image
                  src={Suscription}
